...
export default async function ProfilePage() {
  ...
  if (result.status === "unavailable") return <section className="mx-auto max-w-3xl rounded-xl border border-red-500/40 bg-[#111111] p-6"><h1 className="font-mono text-xl text-gray-100">ไม่สามารถโหลดโปรไฟล์ได้</h1><p className="mt-2 text-sm text-gray-400">กรุณาลองใหม่อีกครั้ง หรือเข้าสู่ระบบใหม่หากปัญหายังคงอยู่</p></section>;
